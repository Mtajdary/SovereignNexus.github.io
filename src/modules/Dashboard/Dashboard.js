  ...
  return (
    <div className="max-w-3xl mx-auto px-4 pt-10 pb-20 text-center" dir="rtl">
      ...
      <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
        سلام، من <strong className="text-gray-900 font-bold">محمد تاجداری</strong> هستم. تمرکز من بر تلفیق مهندسی عمران (نظارت پروژه‌های زیرساخت و راه‌سازی)، پژوهش در بینایی ماشین و هوش مصنوعی (پایش سلامت سازه) و معماری وب‌اپلیکیشن‌های کاربردی متمرکز است.
      </p>
