...
const SovereignHeader = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-16 sm:right-18 z-30 glass border-b border-gold/15 px-4 sm:px-8 py-3 flex justify-between items-center transition-all">
      {/* عنوان برند */}
      <Link
        to="/"
